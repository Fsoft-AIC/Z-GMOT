...
def create_tracker(tracker_type, tracker_config, device):
    ...
    if tracker_type == 'strongsort':
        ...
        return botsort
    elif tracker_type == 'deepocsort': # macsort in first version
        ...
        return deepocsort
    elif tracker_type == 'vanila_deepocsort':
        from boxmot.deepocsort.deepocsort import DeepOCSort
        ...
        return deepocsort
    elif tracker_type == 'masort':
        from boxmot.deepocsort.macsortv2 import MacSortv2
        deepocsort = MacSortv2(
            device,
            det_thresh=cfg.deepocsort.det_thresh,
            max_age=cfg.deepocsort.max_age,
            min_hits=cfg.deepocsort.min_hits,
