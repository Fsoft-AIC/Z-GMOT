...
class VLDyHead(torch.nn.Module):
    ...
    def forward(self, x, language_dict_features=None, embedding=None, swint_feature_c4=None):
        ...
        # flops, macs, params = calculate_flops(model=self.dyhead_tower, 
        #                                     args = [x, language_dict_features],
        ...
        fused_visual_features = None
        self.cfg.MODEL.RPN.RETURN_FUSED_FEATURES = True # add newly
        ...
        # no matter the feature is from backbone or from fpn, we use shallow_img_embs all the time
...
class VLDyHeadModule(torch.nn.Module):
    ...
    def _forward_test(self, box_regression, centerness, anchors,
        ...
        # import pdb; pdb.set_trace()
        boxes, visual_features, fused_visual_features = self.box_selector_test(box_regression, centerness, anchors,
                                       box_cls,
                                       token_logits,
                                       dot_product_logits,
                                       positive_map,
        ...
        # import pdb; pdb.set_trace()
        return boxes, {}, fused_visual_features, visual_features
