...
DATA_DIR = '/cm/shared/kimth1/Tracking/G2MOT/frames/AnimalTrack/test'
BOX_SAVE_DIR = f'./iGLIP_animal/boxes'
FINAL_VIS_DIR = f'./iGLIP_animal/visualize'
...
with open('prompt/animaltrack/specific.json') as f:
    CAPTION_MAP = json.load(f)

with open('prompt/animaltrack/general.json') as f:
