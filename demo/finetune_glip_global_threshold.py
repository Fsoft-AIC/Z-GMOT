...
SAVE_DIR = f'./basename_GLIP_{high_threshold}/vis_before'
DROP_SAVE_DIR = f'./basename_GLIP_{high_threshold}/vis_after'
BOX_SAVE_DIR = f'./basename_GLIP_{high_threshold}/GMOT_40_boxes'
FINAL_VIS_DIR = f'./basename_GLIP_{high_threshold}/vis_final'
